...
if rank == 0:
    ...
    # - apply peak thrust shaving
    mopt['WISDEM']['RotorSE']['peak_thrust_shaving'] = True
   #mopt['WISDEM']['RotorSE']['thrust_shaving_coeff'] = 0.75 # estimated from NREL-2.3-107
    mopt['WISDEM']['RotorSE']['thrust_shaving_coeff'] = 0.788 # estimated peak thrust
