...
## File management
run_dir = './'
fname_wt_input = os.path.join(run_dir, f'outputs.{istep-1}', f'NREL-1p715-103-step{istep-1}.yaml')
...
if rank == 0:
    ...
    aopt['general']['fname_output'] = f'NREL-1p715-103-step{istep}'
    ...
    aopt['design_variables']['blade']['aero_shape']['chord']['min_gain'] = 0.5
    aopt['design_variables']['blade']['aero_shape']['chord']['max_gain'] = 1.5
